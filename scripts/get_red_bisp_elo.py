...
if __name__ == '__main__':
    ...
    parser.add_argument("--lmax", type=int, requred=True,
    ...
    local = ksw.Shape.prim_local(ns=args.ns)
    equilateral = ksw.Shape.prim_equilateral(ns=args.ns)
    orthogonal = ksw.Shape.prim_orthogonal(ns=args.ns)
